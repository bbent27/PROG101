...
# converts fahrenheit to celsius by multiplying by [9/5 - 32]
rect_area <- rect_length * rect_width
# finds area of a rectangle by multiplying width * length
...
squid_weight_g <- 35
energy_per_squid_J <- energy_density_squid_J_g * squid_weight_g
squid_per_dolphin <- dolphin_energy_J / energy_per_squid
